...
export const HeroVacancy = () => {
  ...
  return (
    <section className="max-w-screen relative">
      ...
      <motion.h1
        ref={ref}
        className="absolute w-4/5 md:w-2/4 lg:w-1/2 top-32 left-4 font-extrabold text-2xl lg:top-44 md:left-16 lg:left-24 lg:text-[40px] text-[#635BFF] leading-tight"
        initial="hidden"
        animate={controls}
